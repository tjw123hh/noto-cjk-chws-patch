...
gh release create Sans${VERSION}_CHWS_Patch --title "Noto Sans CJK CHWS Patch Version ${VERSION} (OTF, OTC, Super OTC, Subset OTF, Variable OTF/TTF)" -F git-release-notes.md --target main \
